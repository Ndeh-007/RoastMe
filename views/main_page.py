...
from core.api import fetchJoke
from core.context_menu import open_settings, quit_application, hide_application
...
class ContextMenu(QMenu):
    def __init__(self, position: QPoint):
        ...
        hide_icon = qtawesome.icon("msc.debug-disconnect", color="#ff0000")
        ...
        hide_action.triggered.connect(hide_application)
